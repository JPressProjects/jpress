...
@RequestMapping(value = "/admin/job/job_department", viewPath = JPressConsts.DEFAULT_ADMIN_VIEW)
public class _JobDepartmentController extends AdminControllerBase {
    ...
    public void edit() {
        ...
        JobDepartment entry = entryId > 0 ? service.findById(entryId) : null;
        setAttr("jobDepartment", entry);
        set("now",new Date());
        render("job/job_department_edit.html");
    }
