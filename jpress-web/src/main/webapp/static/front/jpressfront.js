...
function initJPressVideo() {
    ...
    $('head').append(linkE);
    linkE.addEventListener('load', ev => {
        console.log("tcplayer.min.css is defined")
    });
    ...
    $('head').append(linkEl);
    linkEl.addEventListener('load', ev => {
        console.log("aliplayer-min.css is defined")
    });
    ...
    $('.jpress-video').each(function () {
        ...
        if (cloudType != null && cloudType != '' && cloudType == '1') {//阿里云
            ...
            if (vid != "" && aid != "" && id != "") {
                ...
                "https://web.sdk.qcloud.com/player/tcplayer/release/v4.5.2/tcplayer.v4.5.2.min.js"],function (){
                            new TCPlayer(id, {
                                        fileID: vid,
                                        appID: aid,
