...
public class SearcherBean {
	...
	public SearcherBean(String sid, String title, String description,
			String content, String otherInfo, String type) {
		this.sid = sid;
		this.title = title;
...
//		this(doc.get("sid"), doc.get("title"), doc.get("description"), doc.get("content"), doc.get("otherInfo"), doc.get("type"));
//	}
...
//		Field descriptionField = new Field("description", getDescription(), TextField.TYPE_STORED);
//		Field contentField = new Field("content", getContent(), TextField.TYPE_STORED);
//		Field otherInfoField = new Field("otherInfo", getContent(), TextField.TYPE_STORED);
