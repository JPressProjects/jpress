...
public class ModuleGenerator {
    ...
    private final String basePath = PathKit.getWebRootPath() + "/../";
    ...
    private void genCode() {
        ...
        String modelDir = PathKit.getWebRootPath() + "/../" + modelModuleName + "/src/main/java/" + modelPackage.replace(".", "/");
        String baseModelDir = PathKit.getWebRootPath() + "/../" + modelModuleName + "/src/main/java/" + baseModelPackage.replace(".", "/");
        ...
        new ServiceApiGenerator(servicePackage, modelPackage, serviceApiModuleName).generate(tableMetaList);
        new ServiceProviderGenerator(servicePackage, modelPackage, serviceProviderModuleName).generate(tableMetaList);
