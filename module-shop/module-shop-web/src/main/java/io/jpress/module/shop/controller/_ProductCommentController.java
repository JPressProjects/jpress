...
@RequestMapping(value = "/admin/shop/product_comment", viewPath = JPressConsts.DEFAULT_ADMIN_VIEW)
public class _ProductCommentController extends AdminControllerBase {
    ...
    public void index() {
        ...
        render("shop/product_comment_list.html");
    }
    ...
    public void edit() {
        ...
        set("now",new Date());
        render("shop/product_comment_edit.html");
    }
